      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          <Link href="/" className="flex items-center space-x-2">
            ...
            <span className="font-playfair text-xl font-bold text-white">Coral Construct Solutions</span>
          </Link>
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <Button className="ocean-gradient text-white hover:opacity-90 transition-opacity">Get Started</Button>
          </div>
        ...
        {isOpen && (
          <div className="md:hidden glass-effect rounded-lg mt-2 p-4">
            <div className="flex flex-col space-y-4">
              ...
              <Button className="ocean-gradient text-white w-full">Get Started</Button>
            </div>
          </div>
        )}
      </div>
